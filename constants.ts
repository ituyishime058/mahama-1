...
export const mockStreamingContent: StreamingContent[] = [
  ...
  { id: 7, title: 'Godzilla Minus One', genre: 'Action', posterUrl: 'https://image.tmdb.org/t/p/w400/hkxxMIGaiCTmrEArK7J56JTKUlB.jpg', trailerUrl: 'https://www.youtube.com/embed/r7DqccP1Q_4?autoplay=1', description: 'In post-war Japan, a new terror rises. Will the devastated people be able to survive... let alone fight back?' },
