...
const AdvertisePage: React.FC<PageProps> = ({ isOpen, onClose }) => {
  return (
    <InfoPage isOpen={isOpen} title="Advertise with Us" onClose={onClose}>
      ...
      <p>To learn more about our advertising solutions and to request a media kit, please contact our sales team at <a href="mailto:advertise@mahamanews.com" className="text-deep-red dark:text-gold hover:underline">advertise@mahamanews.com</a>.</p>
    </InfoPage>
  );
};
