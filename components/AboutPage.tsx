...
const AboutPage: React.FC<PageProps> = ({ isOpen, onClose }) => {
  return (
    <InfoPage isOpen={isOpen} title="About Mahama News Hub" onClose={onClose}>
      <p className="mb-4">Welcome to Mahama News Hub, where cutting-edge technology meets world-class journalism. Our mission is to provide fast, accurate, and deeply insightful news coverage to a global audience.</p>
