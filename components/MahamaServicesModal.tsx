...
interface MahamaServicesModalProps {
  isOpen: boolean;
  onClose: () => void;
  settings: Settings;
}

const MahamaServicesModal: React.FC<MahamaServicesModalProps> = ({ isOpen, onClose, settings }) => {
      ...
      >
        <div className="p-6 border-b border-slate-200 dark:border-slate-700 flex-shrink-0">
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    <h3 className="font-bold text-2xl">{t('mahamaServices')}</h3>
                    <p className="text-sm text-slate-500 mt-1">{t('mahamaServicesDesc')}</p>
                </div>
            </div>
        </div>
...
export default MahamaServicesModal;