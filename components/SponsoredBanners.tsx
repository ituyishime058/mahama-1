                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {mockSponsors.map((sponsor, index) => (
                        ...
                        >
                            ...
                            <div className="relative p-6 flex flex-col justify-between h-48 text-white transition-transform duration-300 group-hover:translate-z-10" style={{ transform: 'translateZ(20px)' }}>
                             ...
                             <div className="absolute inset-0 border-2 border-transparent rounded-lg group-hover:border-gold transition-all duration-300 animate-glow group-hover:opacity-100 opacity-0"></div>
                        </a>
                    ))}
                </div>
            </div>
